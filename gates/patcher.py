"""
Patch Gate - Gate 3
Applies approved agent patches to st-agent-registry and syncs to runtime.
"""
import hashlib
import re
import subprocess
...
class PatchGate:
    ...
    def run(self, dry_run: bool = False) -> list[PatchApplication]:
        """
        Run patch gate — applies approved agent patches only.
        ...
        # Agent patches: apply CLAUDE.md / agent.yaml changes to st-agent-registry
